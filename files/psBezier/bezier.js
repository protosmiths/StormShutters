    ...
    */
    static toSVG(curves, tol = 0.01)
    {
        ...
        //curves.forEach((curve) =>
        {
            ...
            let start = curve.points[0];
            let end = curve.points[curve.order];
            //console.log("toSVG curve :", start.x, start.y, end.x, end.y);
            if (lastEnd !== null && utils.dist(lastEnd, start) > tol)
            {
                segStart = null;
            }
            if (segStart === null)
